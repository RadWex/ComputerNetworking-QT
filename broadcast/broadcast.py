...
class MySocket(Thread):
    ...
    def mysend(self, msg, host="<broadcast>", port=8000):
        msg = msg.encode()
        try:
...
class MainWidow(QWidget):
    def __init__(self):
        super().__init__()
        self.setWindowTitle("Broadcastig")
        ...
        self.ip_text = QLineEdit(self.socket_send.get_broadcast_IP())
        ...
        grid.addWidget(QLabel("Broadcast address"), 0, 0)
    ...
    def startListenign(self):
        ...
        try:
            ...
            port = 8000
        err_code, output = self.socket_recv.connect("", port)
